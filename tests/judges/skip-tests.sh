...
test_binary_guards_removed() {
  judge_files "tests/mcp/tmux/test_lib.sh" "tests/mcp/tmux/e2e/test_sandbox_debug_profile.sh" "tests/mcp/tmux/e2e/test_mcp_in_sandbox.sh" "tests/mcp/tmux/e2e/test_filesystem_isolation.sh" "tests/mcp/tmux/e2e/test_profile_composition.sh"
